(function () {
    ...
    angular
        .module('MetronicApp')
        .controller('rstokController', rstokController);


    rstokController.$inject = [ '$rootScope','$location','$window','$scope','stokService','$modal'];
    function rstokController( $rootScope,$location,$window,$scope,stokService,$modal) {
